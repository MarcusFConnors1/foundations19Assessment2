...
function canWeDeliver(zipCode){
    for(i = 0; i < deliveryAreaZipCodes.length; i++){
        if(zipCode === deliveryAreaZipCodes[i]){
           return console.log(`We definitely can deliver to ${zipCode}!`)
        } else{
            deliverable = false
        }
    }
...
let update = deals[0].title.replace('15% Off!', "10% Off!")
console.log(update)
...
let updatedDate = deals[1].desc.replace("March! ", "April!")
console.log(updatedDate)
let updatedFormat = deals[1].desc.replace("   ", "")
